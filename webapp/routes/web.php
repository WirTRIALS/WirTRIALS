...
Route::group(['namespace' => 'Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('product','FrontendController@product')->name('home');
    Route::get('handler', 'FrontendController@handler')->name('handler');
    Route::get('privacy', 'FrontendController@privacy')->name('privacy');
    Route::get('terms', 'FrontendController@terms')->name('terms');
    Route::get('topexpertise', 'FrontendController@topexpertise')->name('topexpertise');
    Route::post('contact', 'FrontendController@contact')->name('contact');
    Route::post('favorites', 'FrontendController@insertfav')->name('favorites');
    Route::post('delfavorites', 'FrontendController@delfavorites')->name('delfavorites');
    Route::post('getfavorites', 'FrontendController@getfavorites')->name('getfavorites');
    Route::get('listfavorites', 'FrontendController@listfavorites')->name('listfavorites');
    Route::get('publications', 'FrontendController@publications')->name('publications');
