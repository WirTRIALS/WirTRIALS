...
<div class="main-content">
    ...
    <div class="header bg-gradient-primary py-7 py-lg-8 pt-lg-9" style="background:linear-gradient(0deg, rgba(6,73,178),rgba(80,155,220, 0.8)), url(img/skills.png) !important;" >
        <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        ...
                        <p class="text-lead text-white">
                            Please Enter Your Credentials or Create New Account
                        </p>
                    </div>
                </div>
            </div>
