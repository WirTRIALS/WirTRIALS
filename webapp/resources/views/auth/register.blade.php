...
<div class="main-content">
    ...
    <div class="header bg-gradient-primary py-7 py-lg-8" style="background:linear-gradient(0deg, rgba(6,73,178),rgba(80,155,220, 0.8)), url(img/skills.png) !important;">
        <div class="container">
