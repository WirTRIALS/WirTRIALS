...
<section class="section-header bg-primary text-white pb-7 pb-lg-11" style="background:linear-gradient(0deg, rgba(6,73,178),rgba(80,155,220, 0.8)), url({{asset('img/skills.png')}}) !important;">
    <div class="container">
